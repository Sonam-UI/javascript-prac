...
// logic - if the number of arguments passed is greater than or equal to the number of parameters expected by the original function, we can directly call the original function with those arguments. Otherwise, we return a new function that takes additional arguments and combines them with the previously passed arguments until we have enough to call the original function. 
